...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        # The argument should just be the filename, not the full path
        parser.add_argument('csv_filename', type=str, help='The name of the CSV file (e.g., clothing_products.csv) containing product data, expected in the project root.')

    def handle(self, *args, **options):
        # Construct the full path using settings.BASE_DIR for cross-OS compatibility
            ...
            with open(csv_file_path, mode='r', encoding='utf-8') as file:
                ...
                for row_num, row in enumerate(reader, 1):
                    try:
                        ...
                        # Removed pr_description as it's not in the Product model
                        ...
                        product, created = Product.objects.update_or_create(
                            ...
                            defaults={
                                'pr_price': pr_price,
                                'pr_cate': pr_cate,
                                # Removed pr_description from defaults
